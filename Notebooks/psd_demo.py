...
psds = 10*np.log10( np.transpose(np.vstack([  normaliznormalize(pP.psd)e(pW), normalize(pBT.psd), normalize(pMT.psd), normalize(pEig.psd), normalize(pCov.psd), normalize(pARMA.psd) ])))
